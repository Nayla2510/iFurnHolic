...
<head>
    ...
    <title>Beranda - iFurnHolic</title>
                                ...
                                <div class="col-lg-5 col-md-8">
                                    <div class="banner_text">
                                        <div class="banner_text_iner">
                                            <h1>Temukan Sofa
                                                Elegan di iFurnholic</h1>
                                            <p>Perpaduan kayu dan kain berkualitas untuk menciptakan kenyamanan dan gaya dalam ruang tamu Anda.</p>
                                            <a href="belanja.php" class="btn_2">Beli Sekarang</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="banner_img d-none d-lg-block">
                                    <img src="img/banner_img.png" alt="Sofa Elegan iFurnholic">
                                </div>
                            </div>
                        </div>
                        <div class="single_banner_slider">
                                ...
                                <div class="col-lg-5 col-md-8">
                                    <div class="banner_text">
                                        <div class="banner_text_iner">
                                            <h1>Sofa Modern
                                                Minimalis</h1>
                                            <p>Desain simpel dengan kenyamanan maksimal, sempurna untuk gaya hidup urban modern.</p>
                                            <a href="belanja.php" class="btn_2">Beli Sekarang</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="banner_img d-none d-lg-block">
                                    <img src="img/banner_img.png" alt="Sofa Minimalis iFurnholic">
                                </div>
                            </div>
                        </div>
                        <div class="single_banner_slider">
                            <div class="row">
                                <div class="col-lg-5 col-md-8">
                                    <div class="banner_text">
                                        <div class="banner_text_iner">
                                            <h1>Furniture
                                                Berkualitas dari iFurnholic</h1>
                                            <p>Kreasikan ruang impian Anda dengan pilihan furniture terbaik dari kami, hanya di iFurnholic.</p>
                                            <a href="belanja.php" class="btn_2">Jelajahi Koleksi</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="banner_img d-none d-lg-block">
                                    <img src="img/banner_img.png" alt="Furniture Berkualitas iFurnholic">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-12">
                    <div class="section_tittle text-center">
                        <h2>Ruang Indah<span>Hidup Nyaman</span></h2>
                    </div>
                </div>
            </div>
            <div class="row">
                                    ...
                                    <div class="col-lg-3 col-sm-6">
                                        <div class="single_product_item">
                                            ...
                                            <div class="single_product_text">
                                                ...
                                                <h3>Rp. <?= $harga ?></h3>
                                                <a href="detail_produk.php?<?= $id ?>" class="add_cart">+ keranjang</a>
                                            </div>
                                        </div>
                                    </div>
                                <?php } ?>
        ...
        <div class="container">
            <div class="row align-items-center justify-content-between">
                <div class="col-lg-6 col-md-6">
                    <div class="offer_img">
                        <img src="img/offer_img.png" alt="Promo iFurnholic">
                    </div>
                </div>
                <div class="col-lg-6 col-md-6">
                    <div class="offer_text">
                        <h2>Diskon Mingguan
                            Hingga 60% Semua Produk!</h2>
                        <p>Manfaatkan promo terbatas dari iFurnholic untuk mempercantik rumah Anda dengan furniture berkualitas terbaik.</p>
