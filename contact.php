...
<head>
  ...
  <title>Hubungi Kami - iFurnHolic</title>
      ...
      <div class="row">
        ...
        <div class="col-lg-4">
          ...
          <div class="media contact-info">
            ...
            <div class="media-body">
              <h3>+62 858-6946-6524</h3>
              <p>Hubungi via WhatsApp (Senin-Sabtu, 9 pagi- 5 sore)</p>
            </div>
          </div>
          <div class="media contact-info">
            <span class="contact-info__icon"><i class="ti-email"></i></span>
            <div class="media-body">
              <h3>iFurnHolic@gmail.com</h3>
              <p>Tanyakan pertayaan Anda kapan saja!</p>
            </div>
          </div>
        </div>
      </div>
